...
{
    [BurstCompile]
    public struct RedCubeComponentGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<RedCubeComponent>(),
                    ComponentSize = UnsafeUtility.SizeOf<RedCubeComponent>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<RedCubeComponent>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<RedCubeComponent>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<RedCubeComponent>(backupData, 0);
